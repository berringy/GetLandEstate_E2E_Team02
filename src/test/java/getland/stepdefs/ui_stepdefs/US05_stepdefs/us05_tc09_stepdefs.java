...
public class us05_tc09_stepdefs {
    ...
    public void selectAUserAndClickTheTrashCanButtonAtTheBottomOfTheActionTitle() {
        us05UsersPage.TrashCanButtonUp.click();
    }

    @When("Click on the 'yes' button at the bottom of the message box that appears on the screen 09.")
    public void clickOnTheYesButtonAtTheBottomOfTheMessageBoxThatAppearsOnTheScreen() {
        us05UsersPage.YesButton4Delete.click();
    }

    @Then("System displays fail message for delete 09.")
    public void systemDisplaysFailMessageForDelete() {
        ReusableMethods.visibleWait(us05UsersPage.MessageBox,2);
        Assert.assertTrue(us05UsersPage.MessageBox.getText().contains("cannot be deleted"));
    }
