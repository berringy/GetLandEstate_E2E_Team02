...
@CucumberOptions(//bu notasyon sayesinde hangi scenariolari calistiracagimizi ve hangi raporlari alacagimizi belirtiriz
        ...
        features = "src/test/resources/features/db_features/US10_DB_confirmation_token.feature",
        glue = {"getland/stepdefs/db_stepdefs/us10_stepdefs"},
        tags = "@DB05TC02",
        dryRun = false
)
public class Runner_US10_DB {
}
